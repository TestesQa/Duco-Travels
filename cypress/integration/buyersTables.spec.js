import ValidateScheduleTables from '../actions/validateSchedule';

describe('Validar movimentação dos buyers durante evento',function(){
    
    var validation = new ValidateScheduleTables;
    ...
    it('Verificar se há reuniões repetidas para Anne Connally - mesa 1', function(){
        ...
        validation.validateScheduleTable();
    })
    ...
    it.only('Verificar se há reuniões repetidas para Mishelle Ying - mesa 39', function(){
